...
public class XmlHelper implements SerializeHelper{
    @Override
    public Generatable deserialize(String data, Class classx) {
        XmlMapper xmlMapper=new XmlMapper();
        try{return (Generatable) xmlMapper.readValue(xml,classx);}
        catch (JsonProcessingException e){throw new RuntimeException("Не шмогла deserialize");}
    }
    ...
    public String serialize(Generatable object) {
        ...
        catch (JsonProcessingException e){throw new RuntimeException("Не шмогла serialize");}
    }
}
